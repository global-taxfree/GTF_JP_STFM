...
namespace GTF_Printer
{
    public class GTF_ReceiptPrinter
    {
        ...
        public void PrintSlip_ja(string docid, string retailer, string goods, string tourist, string adsinfo, Boolean bPreview = true, string signInfo = "")
        {
            ...
            {
                dd.JPNPrintTicket(docid, retailer, goods, tourist, adsinfo, signInfo);
            }
            dd = null;
        }
