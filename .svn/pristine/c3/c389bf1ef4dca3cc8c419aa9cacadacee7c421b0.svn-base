        ...
        */
        ...
        public Boolean createBasicTable()
        {
            ...
            try
            {
                ...
                strQuery = "CREATE TABLE IF NOT EXISTS ALIPAY_CONFIRM " +
                           "(SLIP_NO varchar(200),  ALIPAY_ID varchar(200), USER_NAME varchar(200), ALIPAY_BARCODE_NO varchar(200), ALIPAY_LOGIN_ID varchar(200), " +
                           " OUT_ORDER_NO varchar(200),  CONFIRM_DATE varchar(200), CONFIRM_TIME varchar(200), SEND_YN varchar(200)); ";
        ...
        public Boolean data_Migration(JArray arrTemp, string tablename)
        {
            ...
            try
            {
                if (arrTemp != null && arrTemp.Count > 0)
                {
                    ...
                    createCmd.ExecuteNonQuery();
                    /*
                    createCmd.CommandText = "CREATE TABLE IF NOT EXISTS ALIPAY_CONFIRM " +
                                            "(SLIP_NO varchar(200),  ALIPAY_ID varchar(200), USER_NAME varchar(200), ALIPAY_BARCODE_NO varchar(200), ALIPAY_LOGIN_ID varchar(200), " +
                                            " OUT_ORDER_NO varchar(200),  CONFIRM_DATE varchar(200), CONFIRM_TIME varchar(200), SEND_YN varchar(200)); ";
                    ...
                    */
                    ...
                    for (int i = 0; i < arrTemp.Count; i++)
                    {
                        ...
                        else
                        {
                            ...
                            if (tablename.Equals("ALIPAY_CONFIRM"))
                            {
                                strQuery = "insert into " + tablename + "(SLIP_NO, ALIPAY_ID, USER_NAME, ALIPAY_BARCODE_NO, ALIPAY_LOGIN_ID, " +
                                           "OUT_ORDER_NO, CONFIRM_DATE, CONFIRM_TIME, SEND_YN ) values( '" +
                                            tempObj["SLIP_NO"].ToString() + "', '" +  //1
                                            tempObj["ALIPAY_ID"].ToString() + "', '" +  //2
                                            tempObj["USER_NAME"].ToString() + "', '" +  //3
                                            tempObj["ALIPAY_BARCODE_NO"].ToString() + "', '" +  //4
                                            tempObj["ALIPAY_LOGIN_ID"].ToString() + "', '" +  //5
                                            tempObj["OUT_ORDER_NO"].ToString() + "', '" +  //6
                                            tempObj["CONFIRM_DATE"].ToString() + "', '" +  //7
                                            tempObj["CONFIRM_TIME"].ToString() + "', '" +  //8
                                            tempObj["SEND_YN"].ToString() + "');";    //9
                            }
