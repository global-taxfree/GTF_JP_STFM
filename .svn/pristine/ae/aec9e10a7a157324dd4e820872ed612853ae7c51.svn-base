        ...
        private void BTN_SAVE_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                */
                ...
                Constants.TAX_TYPE = COM_TAX_TYPE.SelectedItem.ToString();
                //Constants.SLIP_TYPE = COM_SLIP_TYPE.SelectedItem.ToString();
                Constants.FEE_8_RATE =  TXT_8_RATE.Text.ToString();
                Constants.FEE_10_RATE = TXT_10_RATE.Text.ToString();
                Constants.PRINT_SETTING = COM_PRINT_SETTING.SelectedIndex.ToString();  
                //LOCAL DB 저장
                Constants.SQLITE_MANAGER.updateConfigData("TML_ID", "" + Constants.TML_ID, "터미널번호");
                Constants.SQLITE_MANAGER.updateConfigData("PASSPORT_TYPE", "" + Constants.PASSPORT_TYPE, "여권스캐너");
                Constants.SQLITE_MANAGER.updateConfigData("PRINTER_TYPE", Constants.PRINTER_TYPE, "영수증프린터");
                Constants.SQLITE_MANAGER.updateConfigData("PRINTER_OPOS_TYPE", Constants.PRINTER_OPOS_TYPE, "영수증프린터");
                Constants.SQLITE_MANAGER.updateConfigData("SIGNPAD_USE", Constants.SIGNPAD_USE, "서명패스 사용여부");
                Constants.SQLITE_MANAGER.updateConfigData("PRINT_TYPE", Constants.PRINT_TYPE, "영수증 출력용지");
                Constants.SQLITE_MANAGER.updateConfigData("TAX_TYPE", Constants.TAX_TYPE, "세금 우선순위");
                Constants.SQLITE_MANAGER.updateConfigData("FEE_8_RATE", Constants.FEE_8_RATE, "8% 수수료");
                Constants.SQLITE_MANAGER.updateConfigData("FEE_10_RATE", Constants.FEE_10_RATE, "10% 수수료");
                Constants.SQLITE_MANAGER.updateConfigData("PRINT_SETTING", Constants.PRINT_SETTING, "전자화관련 프린트설정");
