...
namespace GTF_STFM.Util
{
    public class Constants
    {
        ...
        public static string SIGNPAD_USE = string.Empty;            //데스크 ID
        public static string PRINT_TYPE = string.Empty;            //데스크 ID
        public static string TAX_TYPE = string.Empty;            //세금구분
        public static string FEE_8_RATE = string.Empty;            //세금구
        public static string FEE_10_RATE = string.Empty;            //세금구
